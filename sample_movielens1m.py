...
run_experiment("config_files/experiments/movielens1m_42.yml")
run_experiment("config_files/experiments/movielens1m_43.yml")
run_experiment("config_files/experiments/movielens1m_44.yml")
run_experiment("config_files/experiments/movielens1m_45.yml")
run_experiment("config_files/experiments/movielens1m_46.yml")
