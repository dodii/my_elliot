...
run_experiment("config_files/experiments/amazon_instant_video_42.yml")
run_experiment("config_files/experiments/amazon_instant_video_43.yml")
run_experiment("config_files/experiments/amazon_instant_video_44.yml")
run_experiment("config_files/experiments/amazon_instant_video_45.yml")
run_experiment("config_files/experiments/amazon_instant_video_46.yml")