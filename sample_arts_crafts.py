...
run_experiment("config_files/experiments/amazon_arts_crafts_42.yml")
run_experiment("config_files/experiments/amazon_arts_crafts_43.yml")
run_experiment("config_files/experiments/amazon_arts_crafts_44.yml")
run_experiment("config_files/experiments/amazon_arts_crafts_45.yml")
run_experiment("config_files/experiments/amazon_arts_crafts_46.yml")