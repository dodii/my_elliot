...
run_experiment("config_files/experiments/amazon_video_games_42.yml")
run_experiment("config_files/experiments/amazon_video_games_43.yml")
run_experiment("config_files/experiments/amazon_video_games_44.yml")
run_experiment("config_files/experiments/amazon_video_games_45.yml")
run_experiment("config_files/experiments/amazon_video_games_46.yml")