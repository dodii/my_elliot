...
run_experiment("config_files/experiments/amazon_cds_vinyl_42.yml")
run_experiment("config_files/experiments/amazon_cds_vinyl_43.yml")
run_experiment("config_files/experiments/amazon_cds_vinyl_44.yml")
run_experiment("config_files/experiments/amazon_cds_vinyl_45.yml")
run_experiment("config_files/experiments/amazon_cds_vinyl_46.yml")